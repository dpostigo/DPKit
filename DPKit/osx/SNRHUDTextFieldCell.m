...
- (void) drawWithFrame: (NSRect) cellFrame inView: (NSView *) controlView {
    ...
    if ([self isBezeled]) {
        ...
        innerGlow.shadowColor = SNRTextFieldInnerGlowColor;
        innerGlow.shadowOffset = SNRTextFieldInnerGlowOffset;
        innerGlow.shadowBlurRadius = SNRTextFieldInnerGlowBlurRadius;
        ...
        innerShadow.shadowColor = SNRTextFieldInnerShadowColor;
        innerShadow.shadowOffset = SNRTextFieldInnerShadowOffset;
        innerShadow.shadowBlurRadius = SNRTextFieldInnerShadowBlurRadius;
